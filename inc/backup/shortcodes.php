...
function lcoh_masonry($atts) {
	...
	if ($atts['option'] == 'What We Treat') {
		...
		$page_list = array(804,10,23088,805,25313,649,86, 32063);
		// Row of 2
		...
		$html .= '<div class="col-sm-6 col-md-3 lcoh_masonry_col">'.lcoh_masonry_box($page_list[2]).'</div>';
		$html .= '<!-- /masonry row 2 -->';
		...
		$html .= '<div class="col-sm-12 col-md-3 lcoh_masonry_col">'.lcoh_masonry_box($page_list[6]).'</div>';
		$html .= '<!-- /masonry row 3 -->';
	}
		...
		// Row of 2
		$html .= '<div class="col-sm-6 col-md-3 lcoh_masonry_col">'.lcoh_masonry_box($page_list[0],'secondary').'</div>';
		$html .= '<div class="col-sm-6 col-md-3 lcoh_masonry_col">'.lcoh_masonry_box($page_list[1],'secondary').'</div>';
		$html .= '<div class="col-sm-6 col-md-3 lcoh_masonry_col">'.lcoh_masonry_box($page_list[2],'secondary').'</div>';
		$html .= '<div class="col-sm-6 col-md-3 lcoh_masonry_col">'.lcoh_masonry_box($page_list[3],'secondary').'</div>';
